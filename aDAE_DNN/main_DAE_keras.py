...
encoded = Dense(200,activation='relu')(encoded)# for the symetric
decoded = Dense(500,activation='relu')(encoded)
decoded = Dense(fea_dim*agg_num,activation='linear')(decoded) # for the symetric
...
# encoded = Dropout(0.1)(input_audio)
# encoded = Dense(500,activation='relu')(encoded) 
# encoded = Dense(50,activation='relu')(encoded) # for the asymetric
# decoded = Dense(500,activation='relu')(encoded)
# decoded = Dense(fea_dim,activation='linear')(decoded) # for the asymetric
...
# For symetric
autoencoder.fit(tr_X,tr_X,nb_epoch=100,batch_size=100,shuffle=True,validation_data=(te_X,te_X), callbacks=[eachmodel])
