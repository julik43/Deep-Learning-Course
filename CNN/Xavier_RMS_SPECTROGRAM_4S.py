...
class cnn7:
	...
	def train(self):
		...
		""" Trains the model """
		# creates optimizer
		optimizer = tf.train.RMSPropOptimizer(learning_rate=FLAGS.learning_rate).minimize(self.loss, global_step=self.g_step)
		...
		with tf.Session() as sess:
			...
			train_writer = tf.summary.FileWriter('graphs/train_XS_XA_RMS_4S_' + str(FLAGS.learning_rate)+'_'+str(FLAGS.num_epochs))
			valid_writer = tf.summary.FileWriter('graphs/valid_XS_XA_RMS_4S_' + str(FLAGS.learning_rate)+'_'+str(FLAGS.num_epochs))
